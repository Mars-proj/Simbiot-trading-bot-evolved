...
class TradingBotCore:
    def __init__(self, market_state: dict, market_data):
        ...
        self.exchange = MEXCAPI(market_state)  # Для выполнения ордеров
    ...
    async def run_trading(self, symbol: str, strategies: list, balance: float, timeframe: str, limit: int, exchange_name: str) -> list:
        ...
        try:
            trades = []
            # Получаем предсказания от выбранной модели
            ...
            for strategy in strategies:
                try:
                    ...
                    if signal in ['buy', 'sell']:
                        # Вычисляем количество для покупки/продажи (на основе баланса и текущей цены)
                        ...
                        quantity = balance / current_price  # Покупаем/продаём на весь доступный баланс
            ...
            # Retrain the selected model with online learning
